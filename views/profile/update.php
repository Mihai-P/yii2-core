...
$this->title = \Yii::t('core.user', 'Update Profile');
$this->params['breadcrumbs'][] = ['label' => Yii::t('core.user', 'Profile'), 'url' => ['view']];
...
<div class="panel panel-primary">
	...
	<div class="panel-footer">
		<?= Html::submitButton(Yii::t('core.user', $model->isNewRecord ? 'Create' : 'Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
	</div>
</div>
<?php ActiveForm::end(); ?>
